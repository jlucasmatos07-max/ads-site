<!DOCTYPE html><!-- shift 1 emet abbr monta o codigo sozinho p mim (inicial) -->
<html lang="pt-br">
<head>
    <meta charset="UTF-8"><!-- problema de acento -->

    <meta name="viewport" content="width=device-width, initial-scale=1.0"><!-- para ajustar a resolução para dif telas -->
    <title>BloodBornLover</title>
    <link rel ="stylesheet" href ="estilo.css">
</head>
<body>
    <header>
       <h1>BloodBorneLoverzz</h1>
    </header>
   
<nav> <!-- menu que use display: flex. -->
<ul>
    <li><a href ="finais.html">Finais!</a></li>
    <li><a href ="ondecomprar.html">Onde posso comprar o jogo?</a></li>
    <li><a href ="https://youtu.be/KwEWUq41Dck?si=M9u44g-ZBvQNj9_8">Quer saber mais? Clique aqui!</a></li>
    <li><a href ="https://pt.wikipedia.org/wiki/Bloodborne">Wikipedia</a></li>

</ul>
</nav>

<main>
    <article><!-- resumo/historia do jogo/gênero -->
    ...
    <article>
        <h1>Bosses principais</h1>
        <p>A ordem de aparição pode variar de acordo com o progresso do jogo e as escolhas do jogador:</p>
        <br/>
    ...
    <article>
        <h1>Dlc's:Bosses/o que tem de novo?</h1>
        <p>A DLC "The Old Hunters" traz novos personagens, armas e áreas ao jogo, expandindo a narrativa e oferecendo novos desafios para os jogadores, incluindo os bosses a seguir:</p>
        <br/>
        <ul>
